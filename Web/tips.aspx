            ...
            <div class="item active">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Sugerencias para el Viajero</h1>
                        <p>Sugerencias para disfrutar tu viaje a FantasticCity.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid cuerpo">
        <div class="row tips">
            <div class="col-md-6">
                ...
                <h1>DOCUMENTOS</h1>
                <p>No se necesita visado para visitar a FantasticCity, por un lapso de tiempo máximo de 90 días dentro de un año.</p>
            </div>
            <div class="col-md-6">
        ...
        <div class="row tips">
            <div class="col-md-6">
                ...
                <p>Airport Master<br />FantasticCity</p>
            </div>
            <div class="col-md-6">
        ...
        <div class="row tips">
            <div class="col-md-6">
                ...
                <h1>HOSPEDAJES</h1>
                <p>Si aun no has reservado, en FantasticCity encontrarás hospedajes para todos los espíritus viajeros, tanto de lujo, como de mochila.<br />La cultura del couchsurfing aún está desarrollándose.<br />Tripadvisor es un buen consejero +150 hoteles 4 y 5 estrellas.
                </p>
            </div>
            <div class="col-md-6">
